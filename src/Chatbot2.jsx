...
export default function Chatbot2() {
  ...
  useEffect(() => {
    const initialMessages = [
      ...
      {
        text: "Emily this side. Let’s find out if you qualify for the Free Health Coverage and $200/month Grocery Allowance Card — it’s quick and only takes 2 minutes!",
        sender: "bot",
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-4 space-y-2 overflow-y-auto flex flex-col mt-[1%] pb-52">
        ...
        {finalMessage && <CallToAction2 finalMessage={finalMessage} switchNumber={switchNumber}/>}
